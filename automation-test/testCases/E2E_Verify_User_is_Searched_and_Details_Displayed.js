...
describe('E2E_Verify_User_is_Searched_and_Details_Displayed', function() {
    ...
    */
    ...
    step('Check if title text is displayed as expected', async function(){
        await screenCheck.checkIfGivenTextIsPresent(driver, locators['titleLocator'], "Search for a user");
    });
    ...
    step('Check User Deatils Page - Info Section', async function(){
        await screenCheck.checkUserDeatilsPageInfoSection(driver, locators['userInfoSection'],userInfo);
    ...
    step('Check User Deatils Page - Repositories', async function(){
        await screenCheck.verifyAllGivenRepositoriesDisplayed(driver, locators['repoSection'],userInfo.repoDetails);
    });
